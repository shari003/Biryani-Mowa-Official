...
export default function OrderSlabs({ order }: Props) {
    ...
    return (
        <div className='grid grid-cols-12 gap-4 py-6 px-4 m-2 rounded-md bg-slate-300 text-slate-600'>
            ...
            <div className='col-span-3 text-center flex justify-around items-center'>
